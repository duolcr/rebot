...
#HUBOT_JIRA_URL = "https://jira.ringcentral.com"
#HUBOT_JIRA_USER = "ken.li"
#HUBOT_JIRA_PASSWORD = ""
#
# Commands:
...
#  process.env.HUBOT_JIRA_URL = "https://jira.ringcentral.com"
  ...
  get = (msg, where, cb) ->
    ...
    console.log("process.env.HUBOT_JIRA_USER is " + process.env.HUBOT_JIRA_USER + "process.env.HUBOT_JIRA_PASSWORD is " + process.env.HUBOT_JIRA_PASSWORD);
